            ...
            {(activeTab === 'upcoming' ? upcomingWebinars : pastWebinars).map((webinar) => (
              <div key={webinar.id} className="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div className="grid lg:grid-cols-3 gap-0">
                  {/* Speaker Section */}
                  <div className="lg:col-span-1 bg-gradient-to-br from-blue-50 to-orange-50 p-8">
                    <div className="text-center">
                      <img 
      ...
      <section className="py-16 bg-gradient-to-r from-blue-800 to-blue-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
            ...
            />
            <button className="bg-orange-500 hover:bg-orange-600 px-6 py-3 rounded-lg font-semibold transition-colors text-white">
              Subscribe
            </button>
          </div>
        </div>
