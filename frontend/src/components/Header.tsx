      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {/* Nav Links - Orange changed to Teal */}
            ...
            <Link to="/webinars" className={`hover:text-teal-500 transition-colors ${
              location.pathname === '/webinars' ? 'text-teal-500' : 
              isScrolled ? 'text-gray-700' : 'text-white'
            }`}>Webinars</Link>
            <Link to="/placements" className={`hover:text-teal-500 transition-colors ${
              location.pathname === '/placements' ? 'text-teal-500' : 
              isScrolled ? 'text-gray-700' : 'text-white'
            }`}>Placements</Link>
          </nav>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button 
              ...
              className="bg-gradient-to-r from-teal-500 to-teal-600 text-white px-6 py-2 rounded-lg hover:shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center space-x-2" // Orange changed to Teal
            >
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white rounded-lg shadow-lg mt-2 py-4">
            ...
            <div className="px-4 pt-2">
              ...
              <button 
                onClick={() => setShowSignupModal(true)}
                className="w-full bg-gradient-to-r from-teal-500 to-teal-600 text-white px-6 py-2 rounded-lg" // Orange changed to Teal
              >
                Sign Up
              </button>
            </div>
