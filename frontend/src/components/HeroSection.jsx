  ...
  return (
    <section className="relative py-16 px-8 md:px-16 lg:px-24">
      ...
      <div className="max-w-[1240px] mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
        {/* LEFT TEXT SECTION */}
        <div className="space-y-6">
          {/* Title: smaller font, tighter spacing, always full text */}
          <h2
            className="
              text-4xl 
              font-semibold 
            ...
            "
            style={{ maxHeight: "4.8em" }} // roughly 2 lines of text
          >
            {heroSlides[slideIndex].title}
          </h2>

          {/* Subtitle: slightly smaller, readable in two lines max */}
          <p
            className="
              text-gray-600 
              ...
              whitespace-normal break-words
            "
            style={{ maxHeight: "3.5em" }} // around 2 lines visually
          >
            {heroSlides[slideIndex].subtitle}
          </p>
