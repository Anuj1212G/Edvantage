        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.instagram.com/edvantage_learning"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="border-t border-gray-800 mt-12 pt-12">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 text-center">
            ...
            {[
              ...
              <div
                key={index}
                className="bg-gray-800 p-6 rounded-lg shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-800 hover:border-teal-500"
              >
                <div className="text-3xl font-bold text-teal-400 mb-2">{stat.count}</div>
