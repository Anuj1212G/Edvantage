...
const WhyEdvantageSection: React.FC = () => {
  const highlights = [
    ...
    },
    {
      ...
      description: 'Learn from seasoned professionals with decades of industry experience in oil & gas operations and management.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {highlights.slice(0, 3).map((highlight, index) => (
            ...
            >
              {/* Icon */}
              <div className="bg-gradient-to-r from-blue-600 to-orange-500 p-4 rounded-2xl inline-block mb-6 group-hover:scale-110 transition-transform duration-300">
              ...
              {/* Hover Effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600/5 to-orange-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </div>
          ))}
        </div>
        ...
        {/* Value Proposition */}
        <div className="mt-16 bg-gradient-to-r from-blue-900 via-blue-800 to-orange-600 rounded-3xl p-8 md:p-12 text-white">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div>
                <div className="text-3xl font-bold text-orange-300 mb-2">Before</div>
                <p className="text-blue-100">Skills Assessment & Gap Analysis</p>
              </div>
              <div>
                <div className="text-3xl font-bold text-orange-300 mb-2">During</div>
                <p className="text-blue-100">Personalized Learning & Support</p>
              </div>
              <div>
                <div className="text-3xl font-bold text-orange-300 mb-2">After</div>
