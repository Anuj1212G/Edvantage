...
const WhyEdvantageSection: React.FC = () => {
  const highlights = [
    {
      icon: BookOpen,
      title: 'Industry-Aligned Curriculum', // Matches doc: Industry-Aligned Curriculum
      description: 'Courses designed by industry experts with real-world applications and cutting-edge content that matches current industry needs.',
      features: ['Updated quarterly', 'Expert-reviewed', 'Practical focus', 'Case studies']
    },
    {
      icon: Award,
      title: 'Global Certifications', // Matches doc: Global Certifications
      description: 'Internationally recognized certifications that add credibility to your professional profile and open doors worldwide.',
      features: ['Industry recognized', 'Global validity', 'Career boost', 'Skill validation']
    },
    {
      icon: TrendingUp,
      title: 'Placement Support', // Matches doc: Placement Support
      description: 'Our comprehensive placement support and industry connections ensure successful career transitions for our graduates.',
      features: ['Job assistance', 'Resume building', 'Interview prep', 'Network access']
    },
    {
      icon: Users,
      title: 'Expert Trainers', // Matches doc: Expert Trainers with International Experience
      description: 'Learn from seasoned professionals with decades of international industry experience in oil & gas operations and management.',
      features: ['20+ years experience', 'Industry veterans', 'Practical insights', 'Mentorship']
    },
    {
      icon: Building,
      title: 'Corporate Upskilling Solutions', // Matches doc: Corporate Upskilling Solutions
      description: 'Customized training solutions for organizations looking to enhance their team capabilities and operational efficiency.',
  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {highlights.slice(0, 3).map((highlight, index) => (
            ...
            >
              ...
              {/* Hover Effect - Orange changed to Teal */}
          ...
          {highlights.slice(3).map((highlight, index) => (
            ...
            >
              <div className="flex-shrink-0">
                {/* Orange/Yellow changed to Teal/Green */}
        ...
        {/* Value Proposition - Orange changed to Teal */}
        <div className="mt-16 bg-gradient-to-r from-blue-900 via-blue-800 to-teal-600 rounded-3xl p-8 md:p-12 text-white">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div>
                <div className="text-3xl font-bold text-teal-300 mb-2">Before</div> {/* Orange changed to Teal */}
                <p className="text-blue-100">Skills Assessment & Gap Analysis</p>
              </div>
              <div>
                <div className="text-3xl font-bold text-teal-300 mb-2">During</div> {/* Orange changed to Teal */}
                <p className="text-blue-100">Personalized Learning & Support</p>
              </div>
              <div>
                <div className="text-3xl font-bold text-teal-300 mb-2">After</div> {/* Orange changed to Teal */}
