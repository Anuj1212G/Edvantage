...
const PlacementsSuccess: React.FC = () => {
  ...
  // Success story data retained as provided
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-teal-600 text-white py-24 overflow-hidden">
        {/* Animated Background Blobs - Orange changed to Teal */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 tracking-tight text-white drop-shadow-lg
                        bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-white to-teal-300 animate-gradient-text
        ...
        {/* REMOVED: Inline <style> block. CSS moved to global file. */}
      </section>
      ...
      <section className="py-16 bg-gradient-to-br from-blue-50 to-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-3xl p-8 flex flex-col items-center transition-transform transform hover:scale-105 hover:shadow-2xl duration-500">
              {/* Green retained as a secondary color for growth/finance */}
            ...
            {/* Hiring Partners - Orange changed to Teal */}
            <div className="bg-white/80 backdrop-blur-md rounded-3xl p-8 flex flex-col items-center transition-transform transform hover:scale-105 hover:shadow-2xl duration-500">
              <div className="bg-teal-600 p-4 rounded-full w-16 h-16 mb-4 flex items-center justify-center animate-bounce">
              ...
              <div className="md:w-1/2 bg-gradient-to-b from-white/80 to-blue-50 p-6 flex flex-col justify-between rounded-r-3xl shadow-lg hover:shadow-2xl transition-shadow duration-500 overflow-hidden">
                <div>
                  <div className="flex items-center mb-4 space-x-1">
                    {[...Array(5)].map((_, i) => (
                      // Star color retained as yellow for standard 5-star rating visual
